...
},
{
  "type": "text",
  "question": "Угадай персонажа по описанию:",
  "prompt": "После одной судьбоносной ночи с наемником я решил то прощения мало и нужен приговор где я быстро переквалифицировался в наёмника и оказался там, где за работу платят, а мораль не спрашивают.",
  "correct": ["Масакр"],
  "time": 60,
  "points": 1600
}
