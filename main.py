...
},
{
  ...
  "type": "text",
  "question": "Угадай персонажа по описанию:",
  "prompt": "Я существую между мирами: то меня бьют — то нет. Я переворачиваю логику боя и выигрываю там, где это кажется невозможным. Лучшие друзья с Осой.",
  ...
  "type": "text",
  "question": "Угадай персонажа по описанию:",
  "prompt": "Олдскульная легенда: поначалу выглядит «никаким», но затем набирает ход. Любит накапливать заряды, разгоняться с каждым комбо и в затяжных боях становится настоящим убийцей. Главное правило — держать серию: лишние удары получать нельзя.",
  "correct": ["Эйгон"],
  "time": 35,
  "points": 1600
},
...
},
{
  "type": "text",
  "question": "Угадай персонажа по описанию:",
  "prompt": "Металл вокруг — мой союзник: мои тяжи сначала кажутся не такими страшными… а потом ты уже не успеваешь сказать: «как это было больно».",
  "correct": ["Магнето", "Магнит"],
  "time": 35,
  "points": 1400
},
...
},
{
  "type": "text",
  "question": "Угадай персонажа по описанию:",
  "prompt": "Я выгляжу как «милый зверёк», люблю вилять хвостом после победы над противником… но это ровно до тех пор, пока ты не поймёшь: у меня всё строится на темпе и точных тройных ударах. Если ты послущный противник — я тебя просто разорву на части, а ты даже не сразу поймёшь, что произошло.",
  "correct": ["Тигра", "Tigra"],
  "time": 35,
  "points": 1500
},
...

{
  ...
  "correct": ["Шанг-Чи", "Шан-Чи", "Shang-Chi", "Shang Chi"],
  "time": 35,
  "points": 1500
},
{
    ...
    try:
        while True:
            ...
            if role == "player" and data.get("type") == "appeal_request":
                ...
                quiz_list = QUIZZES.get(quiz_name, []) if quiz_name else []
